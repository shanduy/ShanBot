...
const pegatinas = async (media) => new Promise(async (resolve, reject) => {	
const musica = async (media) => new Promise(async (resolve, reject) => {
...
const banner = cfonts.render(('SHAN|BOT V2'), {
    font: 'chrome',
    color: 'green',
    align: 'center',
    gradient: ["red","yellow"],
